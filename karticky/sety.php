        ...
        */
        ...
        while ($row = mysqli_fetch_assoc($sqlstat)) {
            ...
            <a href='set.php?set_id=$setID'>
                <button type='button' class='btn btn-success' style='margin-right: 53px; margin-left: 10px;' onclick='get_nazev($setID)'>
                    " . $row["nazev"] . ' - ' . $row["jazyk"] . "
                </button>
            </a>
        ...
        echo "<a href='login.php'><button type='button' class='btn btn-success'>Přihlaš se</button></a>";
    }
...
<div class="bottom" >
    <div class="d-grid gap-2 " >
        <button class="btn btn-primary" type="button" >
         ...
         <!-- Nápad - caller když se přihlašuji odtud, tak že po přihlášeníá mě to hodí zpět sem, respektive na vytvoření setů  -->
    </div>   
</div>
</a>
</body>
